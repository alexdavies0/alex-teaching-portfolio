export const artworks = [
  {
    ...
    ks: "Key Stage 4",
    description: "Inspired by the illustrative mazes of Sean C Jackson, this work explores the theme 'Lock' and was created as a final GCSE exam piece. It was developed through hand drawn studies into a digital illustration using Adobe Illustrator.",
  ...
  },
  {
    ...
    ks: "Key Stage 3",
    description: "These paintings, inspired by Cubist still life artworks by Juan Gris and Pablo Picasso, explore how objects can be shown from multiple viewpoints in a single artwork. During the projects students learn abstraction techniques as well as colour mixing",
